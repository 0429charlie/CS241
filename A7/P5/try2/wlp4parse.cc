...
//-----------------------------------------------------------------------------------------------------------------------
//		cout << "Element to go through: " << endl;
//		for (int q = 0; q < element.size(); q++) {
//			cout << element[q] << endl;
//		}
//		cout << endl;
//-----------------------------------------------------------------------------------------------------------------------
		...
		//	if (element[e] == "NUM" || element[e] == "STAR") {
//				cout << endl;
//				cout << "HHHHHH" << endl;
//				cout << endl;
//				for (int vii = 0; vii < v->size(); vii++) {
//					if ((*v)[vii]->value == element[e]) {
//						rn->children.push_back((*v)[vii]);
//						v->erase(v->begin()+vii);
//						break;
//					}
//				}
...
//                              	cout << vi << endl;
//                              	cout << v->size() << endl;
                  	             	if ((*v)[vi]->value == element[e]) {
                                        	rn->children.push_back((*v)[vi]);
                                        	v->erase(v->begin() + vi);
                                        	break;
                                	}
				}
...
//	if (tree->value == "paramlist" || tree->value == "term") {
//		for (int ii = tree->children.size()-1; ii >= 0; ii--) {
//			Printtree(tree->children[ii]);
//		}
//	} else {
